...
export function CommentItem({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          padding.replace("pt-3", "pt-0").replace("pt-2.5", "pt-0")
        )}
      >
...
function getReactionIcon(reaction: string, depth: number = 0): ReactElement {
  const size = depth === 0 ? "h-4 w-4" : "h-3.5 w-3.5";
  const icons: Record<string, ReactElement> = {
    like: (
      <svg
        className={cn(size, "text-blue-600")}
        fill="currentColor"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
      >
    ...
    love: (
      <svg
        className={cn(size, "text-red-600")}
        fill="currentColor"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
      >
    ...
    haha: (
      <svg
        className={cn(size, "text-yellow-600")}
        fill="currentColor"
        viewBox="0 0 24 24"
        xmlns="http://www.w3.org/2000/svg"
      >
