    ...
    >
      ...
      {imageUrl && (
        ...
        >
          <img
            src={imageUrl}
            alt="Post image"
            className="w-full max-h-[400px] object-cover rounded-lg cursor-pointer hover:opacity-95 transition-opacity border border-border/50"
            onClick={(e) => {
              e.stopPropagation();
      ...
      <div className="px-4 pb-3 pt-2 border-t border-border/50">
        <div className="flex items-center justify-between">
          ...
          {/* Right: Comment Count + React Button */}
          <div className="flex items-center gap-3">
            {/* Comment Count */}
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-xs text-foreground/70">React</span>
              </button>
              {showReactionModal && (
                <ReactionModal
                  postId={id}
...
function getReactionIcon(reaction: string): JSX.Element {
  const icons: Record<string, JSX.Element> = {
    like: (
      <svg className="h-4 w-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    love: (
      <svg className="h-4 w-4 text-red-600" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
      </svg>
    ),
    haha: (
      <svg className="h-4 w-4 text-yellow-600" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
