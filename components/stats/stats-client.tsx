        ...
        <div className="min-h-screen bg-[#f4f4f4] text-slate-900 font-serif pb-12">
          <div className="bg-black text-white py-2 overflow-hidden whitespace-nowrap border-b-2 border-slate-800">
            <div className="animate-marquee inline-block font-mono text-xs md:text-sm font-bold tracking-widest">
              LOADING STATS /// FETCHING LIVE DATA ///
            </div>
          </div>
          ...
          <div className="p-4 md:p-6 lg:p-10 space-y-8 md:space-y-10">
            ...
            <div className="bg-white border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-4 md:p-8 overflow-hidden">
              <div>
                ...
                <div className="overflow-hidden">
                  <OverallResultsBarChartClient data={distribution} />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] md:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] p-4 md:p-8 overflow-hidden">
              <div>
                ...
                <div className="overflow-hidden">
                  <AverageScoresBarChartClient data={averageScores} />
                </div>
              </div>
            </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              ...
              >
                <OverallResultsPieChartClient data={distribution} />
              </ChartCard>
