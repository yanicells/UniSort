...
here is copilot-instructions.md this is generated by copilot. i want you to give me a prompt for the remaining information that we need. because i want to be able to analyze each part page by page so that we can drastically improve the UI.
